...
- P0에는 umbrella package `@lk-robotics/design-system-3d`를 만들지 않는다.
...
@lk-robotics/design-system-3d-core/coordinates
@lk-robotics/design-system-3d-core/entities
@lk-robotics/design-system-3d-core/camera
@lk-robotics/design-system-3d-core/interaction
@lk-robotics/design-system-3d-core/renderer
@lk-robotics/design-system-3d-core/time
@lk-robotics/design-system-3d-core/theme
```
...
@lk-robotics/design-system-3d-assets/schema
@lk-robotics/design-system-3d-assets/legacy
```
