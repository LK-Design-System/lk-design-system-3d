...
```tsx
import { AmrRobot, GoalMarker, PathRibbon, SceneCanvas } from "@lk-design-system/lds-3d-r3f";
...
```tsx
import { PointCloudLayer, SceneCanvas } from "@lk-design-system/lds-3d-r3f";
...
```tsx
import { OccupancyGridSurface, SceneCanvas } from "@lk-design-system/lds-3d-r3f";
