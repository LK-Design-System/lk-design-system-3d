...
export const expectedStoryIds = [
  ...
  "lds-3d-lds-integration-so-arm-joint-viewer--trajectory-replay",
  "lds-3d-lds-integration-so-arm-joint-viewer--inverse-kinematics",
  "lds-3d-scenes-occupancy-grid--overview",
  "lds-3d-scenes-tf-marker--overview",
  "lds-3d-scenes-tf-marker--live-stream",
